...
export default function App({navigation}) {
    const [data, setData] = useState([
        ...
        {key: '1', type: 'Vegetable', name: 'Pear', price: '28.00', image: require('../assets/Image102.png'), sl: 2},
        {key: '1', type: 'Vegetable', name: 'Avocado', price: '28.00', image: require('../assets/Image103.png'), sl: 3},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image105.png'), sl: 1},
        {key: '1', type: 'Vegetable', name: 'Orange', price: '28.00', image: require('../assets/Image106.png'), sl: 4},
        {key: '1', type: 'Vegetable', name: 'Peach', price: '28.00', image: require('../assets/Image107.png'), sl: 1},
        {key: '1', type: 'Vegetable', name: 'Coconut', price: '28.00', image: require('../assets/Image105.png'), sl: 1},
                    ...
                    ({item}) => (
                        <View style={{
                            ...
                            <View>
                                ...
                                <View>
                                    <Image source={require('../assets/Image180.png')}
                            ...
                            <View style={{marginLeft: 140, flexDirection: 'row', alignItems: 'center'}}>
                                <Image source={require('../assets/Image176.png')}
                                    style={{width: 15, height: 15, marginTop: 10}}
                                />
                                <Text style={{fontSize:15}}>{item.sl}</Text>
                                <Image source={require('../assets/Image175.png')}
                                    style={{width: 15, height: 15, marginTop: 10}}
                                />
                            </View>
                        </View>
